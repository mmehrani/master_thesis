...
\begin{mohsenletter}
	...
	\direct{خروجی این مکالمات و چند جلسه پشت سرهم در ادامه‌ی این بخش خواهد آمد.}
\end{mohsenletter}
...
\begin{mohsenletter}
	...
	محسن
	\attrib{جمعه، ۷ مرداد ۱۴۰۱}
	\direct{به نظر میاد همه‌ی کلید مسئله در مشاهده‌ی دقیق‌تر فضای فاز نهفته بود. پس از ابتدا باید از حالات‌های مختلف سامانه نمونه‌گیری می‌کردم.
	}
\end{mohsenletter}
...
\begin{mohsenletter}
	...
	محسن\\
	\direct{
		محاسبات اولم صحیح نبود. مساله حل نشد.
	}
	\attrib{چهارشنبه، ۴ خرداد ۱۴۰۱}
	\medskip
	\speak{محسن}
	استاد خبر خیر!
	...
	سامان
	\attrib{پنجشنبه، ۵ خرداد ۱۴۰۱}
	\direct{
		بازم صحیح نبود اما کمتر ایراد داشت. در بخش بعد توضیح داده‌ام که چرا راه‌حل پیشین شامل ایرادی اساسی است.
	}
