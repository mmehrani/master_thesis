...
\begin{figure}[h]
	...
	\caption{تحول میدان سامانه‌ای تک‌جریان و با تیزه‌های پهن از اخنلالی کوچک از حالت پایا}
...
\begin{align}
	...
	E(t) &= a - \frac{g}{2\pi} \int_{0}^{\infty} ds_1 \big( a - \frac{g}{2\pi} \int ds_2 E(t - 2d - s_1 - s_2) \alpha^2 s_2 e^{-\alpha s_2} \big) \alpha^2 s_1 e^{-\alpha s_1} \\
	&= a \big[ 1 - \frac{g}{2\pi} + (\frac{g}{2\pi})^2 + ... + (\frac{-g}{2\pi})^{\floor{t/d} - 1} \big] \\
	&\hspace{3mm}+ (\frac{-g}{2\pi})^{\floor{t/d}} \int_{0}^{\infty}\int ... \int E(t - nd - s_1 - s_2 - ... - s_n) \alpha^{2n} s_1 s_2 ... s_n e^{-\alpha(s_1 + s_2 + ... + s_n)} ds_1 ds_2 ... ds_n\\
	&= \mathcal{K}_{a,g}(t)\\
	&\hspace{3mm}+ (\frac{-g}{2\pi})^{\floor{t/d}} \int_{0}^{\infty}\int ... \int E(t - nd - s_1 - s_2 - ... - s_n) \alpha^{2n} s_1 s_2 ... s_n e^{-\alpha(s_1 + s_2 + ... + s_n)} ds_1 ds_2 ... ds_n
\end{align}
که در این رابطه 
...
آخرین گام این رابطه در زمانی است که بخشی از آن در حالت مقید قرار دارد و بخشی از آن در حالت پویا. پس برای آن که معادلات را ساده‌تر کنیم؛ تغییر متغیر
$r \equiv \sum s_i$
را می‌دهیم و سپس آن را به دو بخش تقسیم می‌کنیم.\\
...
\begin{align}
	&= \int_{0}^{\infty}\int E(t - nd - r) \alpha^{2n} e^{-\alpha r} \frac{e^{ipr}}{2\pi} (-p)^{-2n} dp dr\\
	&= \int_{0}^{\infty} E(t - nd - r) \alpha^{2n} e^{-\alpha r} \frac{2\pi}{2\pi (2n-1)!} i \cdot \frac{\partial^{2n-1} e^{ipr}}{\partial p^{2n-1}}|_{p=0} dr\\
	&= \frac{1}{(2n-1)!}\int_{0}^{\infty} E(t - nd - r) \alpha^{2n} e^{-\alpha r} i \cdot (ir)^{2n-1} dr\\
	&= \frac{(-1)^n}{(2n-1)!} \int_{0}^{\infty} E(t - nd - r) \alpha^{2n} e^{-\alpha r} r^{2n-1} dr\\
	&= \frac{(-1)^n}{(2n-1)!} \int_{t-nd}^{\infty} E(t - nd - r) \alpha^{2n} e^{-\alpha r} r^{2n-1} dr + \frac{(-1)^n}{(2n-1)!} \int_{0}^{t - nd}E(t - nd - r) \alpha^{2n} e^{-\alpha r} r^{2n-1} dr\\
	&= \frac{(-1)^n}{(2n-1)!} \int_{t-nd}^{\infty} (E_0 + \epsilon) \alpha^{2n} e^{-\alpha r} r^{2n-1} dr + \frac{(-1)^n}{(2n-1)!} \int_{0}^{t - nd}(E_0 - g\epsilon/2\pi) \alpha^{2n} e^{-\alpha r} r^{2n-1} dr\\
	&= \frac{(-1)^n}{(2n-1)!} (E_0 + \epsilon) \int_{0}^{\infty} \alpha^{2n} e^{-\alpha r} r^{2n-1} dr + \frac{(-1)^n}{(2n-1)!} ( - \epsilon - g\epsilon/2\pi) \int_{0}^{t - nd} \alpha^{2n} e^{-\alpha r} r^{2n-1} dr\\
	&= \frac{(-1)^n}{(2n-1)!} (E_0 + \epsilon) (2n - 1)! + \frac{(-1)^n}{(2n-1)!} ( - \epsilon - g\epsilon/2\pi) \int_{0}^{t - nd} \alpha^{2n} e^{-\alpha r} r^{2n-1} dr\\
	&= (-1)^n (E_0 + \epsilon) + \frac{(-1)^n}{(2n-1)!} ( - \epsilon - g\epsilon/2\pi) \gamma(2n,\alpha( t-nd))\\
\end{align}

پس در نهایت برای میدان خواهیم داشت:
\begin{align}
	E(t) &= \mathcal{K}_{a,g}(t) \\
	&\hspace{3mm}+ (\frac{-g}{2\pi})^n (-1)^n (E_0 + \epsilon) \\
	&\hspace{3mm}+ (\frac{-g}{2\pi})^n \frac{(-1)^n}{(2n-1)!} ( - \epsilon - g\epsilon/2\pi) \gamma(2n,\alpha( t-nd))\\
	&= \mathcal{K}_{a,g}(t) \\
	&\hspace{3mm}+ (\frac{g}{2\pi})^n (E_0 + \epsilon)\\
	&\hspace{3mm}+ (\frac{g}{2\pi})^n ( - \epsilon - g\epsilon/2\pi) \frac{\gamma(2n,\alpha( t-nd))}{(2n-1)!}\\
	&= \mathcal{K}_{a,g}(t) \\
	&\hspace{3mm}+ (\frac{g}{2\pi})^{\floor{t/d}} (E_0 + \epsilon)\\
	&\hspace{3mm}+ (\frac{g}{2\pi})^{\floor{t/d}} ( - \epsilon - g\epsilon/2\pi) \frac{\gamma(2\floor{t/d},\alpha d( t/d - \floor{t/d}))}{(2n-1)!}\\
\end{align}
...
\begin{enumerate}
	...
	\begin{align}
		&= a \big[ 1 - \frac{g}{2\pi} + (\frac{g}{2\pi})^2 + ... + (\frac{-g}{2\pi})^{\floor{t/d} - 1} \big] + (\frac{g}{2\pi})^{\floor{t/d}} (E_0 + \epsilon)
	\end{align}
	...
	\begin{align}
		&= a \big[ 1 - \frac{g}{2\pi} + (\frac{g}{2\pi})^2 + ... + (\frac{-g}{2\pi})^{\floor{t/d} - 1} \big] + (\frac{g}{2\pi})^{\floor{t/d}} (E_0 - g\epsilon/2\pi)
	\end{align}
